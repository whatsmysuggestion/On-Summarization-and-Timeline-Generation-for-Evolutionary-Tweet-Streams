...
<head>
<title>View All User Added Post</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style8"><span class="style11">A<span class="style5">ll</span> U<span class="style5">ser</span> A<span class="style5">dded </span>P<span class="style5">osts</span></span></span></h2>
        ...
        <div class="article">
          ...
          <p><table width="539" border="1" align="center"  cellpadding="0" cellspacing="0"   font-size:14px;">
                   <tr>
					 ...
					 <td  width="130" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Topic ID</div></td>
					 <td  width="130" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Profile_Pic</div></td>
					  <td  width="100" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Topic Name</div></td>
                     <td  width="60" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Uploaded User</div></td>
					 <td  width="100" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Date</div></td>
					 <td  width="100" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Tweet</div></td>
		    <tr>
...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
					  ...
					  try{
					            ...
					            String sn="",topicname="",date="";
								Statement stmt=connection.createStatement();
								String strQuery = "select * from tweettopic where user='"+uname+"'";
                  ...
                  <%out.println(sn);%>
						...
						<div class="style12" style="margin:10px 13px 10px 13px;" >
                		 <a class="#" id="img1" href="#" >
							<input  name="image" type="image" src="topicimages.jsp?id=<%=sn%>" style="width:90px; height:90px;"  />
				   		</a>                	</div>			  </td>
						<td  valign="baseline" height="0"><span class="style12">&nbsp;&nbsp;
			  ...
			  <td  valign="baseline" height="0"><div align="center"><a href="UTweet.jsp?i=<%=sn%>&name=<%=topicname%>">Tweet</a></div></td>
	        </tr>
                        <%
