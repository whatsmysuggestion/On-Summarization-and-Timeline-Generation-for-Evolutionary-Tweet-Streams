...
st.executeUpdate("insert into  usertweets (topicid,user,tweet,dt) values ('"+id+"','"+str+"','"+tweet+"','"+dt+"')" );
...
%>
          ...
          <h2><span class="style11">T<span class="style5">weet</span></span> A<span class="style5">dded</span> S<span class="style5">ucessfully </span></h2>
          </p>
          <div class="clr"></div>
