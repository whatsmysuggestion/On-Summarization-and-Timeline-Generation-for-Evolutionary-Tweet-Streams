      ...
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <p><table width="539" border="1" align="center"  cellpadding="0" cellspacing="0"   font-size:14px;">
                   <tr>
				     <td  width="50" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">SINO</div></td>
                     <td  width="130" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Sender</div></td>
					 <td  width="130" valign="baseline" height="28" style="color: #2c83b0;"><div align="center" class="style15 style8 style10">Request From </div></td>
...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
					  ...
					  try{
					            ...
					            String sn="",from="",to="",date="",status="",img="";
								Statement stmt=connection.createStatement();
								String strQuery = "select * from requests where reqto='"+uname+"'";
								...
								String strQuery1 = "select * from user where username='"+from+"'";
            ...
            <tr>  <td  valign="baseline" height="0"><span class="style11">&nbsp;&nbsp;
            ...
            <td width="134" rowspan="1" >
						<div style="margin:10px 13px 10px 13px;" >
                		 <a class="#" id="img1" href="#" >
							<input  name="image" type="image" src="profilepic_image.jsp?uid=<%=img%>" style="width:80px; height:80px;"  />
				   		</a>                	</div>
			  </td>
						...
						%>
                        <td  width="102" valign="baseline" height="0" style="color:#000000;"align="center"><a href="AcceptRequest.jsp?uid=<%=sn%>">waiting&nbsp;</a></td>
                        <%
						}
						else
						{
