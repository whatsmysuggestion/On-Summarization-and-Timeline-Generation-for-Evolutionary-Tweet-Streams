...
<head>
<title>All Tweets Topic Ranks</title>
...
<div class="main">
  ...
  <td width="119"><div align="center" class="style10"><span class="style3">Topic Name </span></div></td>
   <td width="87"><div align="center" class="style10"><span class="style3">Rank</span></div></td>
  </tr>
  <%@ include file="connect.jsp" %>
<%
 
      	
String tid="",tname="",rank="";


      	try 
	{
           
           String query="select * from tweettopic order by count desc"; 
...
%>
  ...
  <tr>
  	<td height="117"><div align="center"><%=tid%></div></td><td><div align="center">
    <input  name="image2" type="image" src="images.jsp?imgid=<%=tid%>" width="100" height="100" alt="Submit" /></div></td>
