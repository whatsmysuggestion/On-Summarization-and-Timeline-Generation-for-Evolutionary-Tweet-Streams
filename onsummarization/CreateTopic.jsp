    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <p> <form action="insertusertopic.jsp" method="post" enctype="multipart/form-data">
		  <table width="600" border="0" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					...
					<tr>
					  <td  width="188" valign="middle" height="45" style="color: #2c83b0;"><div align="left" class="style15 style5" style="margin-left:20px;"><strong>Topic Name  </strong></div></td>
					  <td  width="412" valign="middle" height="45" style="color:#000000;"><div align="left" style="margin-left:20px;"><input type="text" name="tname"></div></td>
					</tr>
					...
					<tr>
					  <td   width="188" align="left" valign="middle" height="74" style="color: #2c83b0;"><div align="left" class="style5 style15" style="margin-left:20px;"><strong>Select Image </strong></div></td>
