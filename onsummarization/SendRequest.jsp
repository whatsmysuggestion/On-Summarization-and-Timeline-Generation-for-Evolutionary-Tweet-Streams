...
<head>
<title>View and Send Request</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2> F<span class="style5">riend</span>  P<span class="style5">rofile </span></h2>
          <div class="clr"></div>
          
          <div class="post_content">
           
		   <p><div class="post_content">
            <p><table width="597" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
...
<td  width="191" align="left" valign="middle" height="40"><div align="left" style="margin-left:20px;"><%out.println(s4);%></div></td>
            ...
            <p>&nbsp;</p>
            <p align="right" class="style15"><a href="SendRequest1.jsp?to=<%=name%>">Send Request </a></p>
