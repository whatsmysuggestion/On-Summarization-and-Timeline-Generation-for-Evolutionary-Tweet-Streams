    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
		  <li class="style13"><span class="style5">WelCome To</span><span class="style11"> <%=(String)application.getAttribute("uname")%></span></a></li>
            <li><a href="UserProfile.jsp">User Profile </a></li>
            <li><a href="SearchFriends.jsp">Search friends and send request </a></li>
            <li><a href="TweetDetails.jsp">Tweet Details </a></li>
