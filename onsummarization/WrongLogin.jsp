...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li ><a href="AdminLogin.html"><span>Admin Main </span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Please enter valid  U<span class="style5">serID and </span>P<span class="style5">assWord</span></span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="AdminLogin.html">Admin Main </a></li>
