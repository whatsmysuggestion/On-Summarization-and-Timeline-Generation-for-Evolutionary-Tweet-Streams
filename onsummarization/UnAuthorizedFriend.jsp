...
<head>
<title>UnAuthorized Friend</title>
...
.style8 {color: #9e4c66}
.style15 {padding:0; margin:0; width:100%; line-height:0; clear: both;}
.style16 {font-size: 22px}
.style17 {color: #76b9e4; font-size: 22px; }
-->
</style>
</head>
<body>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2><span class="style8"><span class="style17">You Cannot sent Request </span></span><span class="style17">Because</span><span class="style16"> F<span class="style5">riend</span> is U<span class="style5">nauthorized </span></span></h2>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="SearchFriends.jsp">Search friends and send request </a></li>
            <li><a href="Register.jsp">List all accepted friends</a></li>
            <li><a href="AdminLogin.html">View all friends</a></li>
