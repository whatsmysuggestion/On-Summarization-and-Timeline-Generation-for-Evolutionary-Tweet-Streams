...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Well Come to A<span class="style5">dmin </span>M<span class="style5">ain</span></span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="ViewAllUsers.jsp">List Users and authorize</a></li>
            <li><a href="ViewAllFriendsRequests.jsp">View  all friends links </a></li>
            <li><a href="AllUserTweets.jsp">View all  tweets as it is</a></li>
            <li><a href="AllTweetsSearchHistory.jsp">List All Tweet’s Search History</a></li>
			<li><a href="AllTweetsTopicRanks.jsp">View all Tweets topic ranks</a></li>
			<li><a href="TimeTweet.jsp">View all tweets based on Time Line</a></li>
            <li><a href="TweetsBasedOnTweetStreamClustering.jsp">All tweets based on Tweet stream clustering </a></li>
          </ul>
        </div>
        <div class="gadget">
