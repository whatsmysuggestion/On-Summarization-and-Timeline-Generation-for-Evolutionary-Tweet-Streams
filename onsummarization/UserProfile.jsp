...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li  class="active"><a href="UserLogin.html"><span>User Login </span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> U<span class="style5">ser</span> P<span class="style5">rofile</span></span></h2>
          <div class="clr"></div>
        ...
        <div class="article">
          <table width="597" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
					
					
					<%@ page import="java.sql.*"%>
<%@ include file="connect.jsp" %>
<%@page import ="java.util.*,java.security.Key,javax.crypto.Cipher,javax.crypto.spec.SecretKeySpec"%>
...
<td  width="191" align="left" valign="middle" height="40"><div align="left" style="margin-left:20px;"><%out.println(s4);%></div></td>
                ...
                <p align="right"><strong><a href="UserMain.jsp">Back</a></strong></p>
                <div class="post_content">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="UserMain.jsp">UserMain </a></li>
