...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style11">T<span class="style5">weet</span></span></h2>
          </p>
          <div class="clr"></div>
...
String str=(String)application.getAttribute("uname");
%>
	
	
	</p>
		
			<form id="form1" name="form1" method="post" action="Tweet1.jsp?str=<%=str%>&i=<%=id%>&name=<%=name%>">  
        <table width="452" border="0">
          <tr>
              <td width="167" rowspan="4" ><div class="style5" style="margin:10px 13px 10px 13px;" > 
             <div align="center" class="style8"> <a class="#" id="img1" href="#" >
               <input  name="image" type="image" src="images.jsp?imgid=<%=id%>"  style="width:100px; height:100px; margin:10px 10px 10px 10px;">
             </a> </div>
     </div></td>
            <th width="104" scope="col"><div align="center">ID</div></th>
            <th width="167" scope="col"><%=id%></th>
          </tr>
          <tr>
          
            <td><div align="center"><strong>Topic Name </strong></div></td>
            <td><div align="center"><%=name%></div></td>
          </tr>
          <tr>
       
            <td><div align="center"><strong>Tweet</strong></div></td>
            <td>
              <label>
          ...
          <p align="right"><a href="ViewAllUserAddedPost.jsp">Back</a></p>
