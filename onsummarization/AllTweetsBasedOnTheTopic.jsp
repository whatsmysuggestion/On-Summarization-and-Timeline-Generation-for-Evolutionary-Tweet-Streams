...
<head>
<title>All Tweets Based On A Topic</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style11">All Tweets Based On A Topic <span class="style5"></span></span></h2>
          </p>
          <div class="clr"></div>
    ...
    <form id="form2" name="form2" method="post" action="AllTweetsBasedOnTheTopic.jsp">
    <table width="385" border="0" align="center">
      <tr>
        <th width="199" height="43" scope="col"><span class="style13">Enter The Topic Name</span></th>
        ...
        <td>&nbsp;</td>
              ...
              <%      
					...
					try{
								...
								String strQuery1 = "select * from tweettopic where topicname='"+tname+"'";
          ...
          <p><table width="583" border="1" align="center"  cellpadding="0" cellspacing="0"   font-size:14px;">
                      <tr>
                      ...
                      <%
					                       ...
					                       String stid=String.valueOf(id1);  
					 
					  
					
								Statement stmt=connection.createStatement();
								String strQuery = "select * from usertweets where topicid='"+stid+"' ";// and user='"+uname+"'";
                     ...
                     <td width="113" rowspan="1" >
					   <div style="margin:10px 13px 10px 13px;" >
                		 <a class="#" id="img1" href="#" >
							<input  name="image" type="image" src="images.jsp?imgid=<%=id1%>" style="width:80px; height:80px;"  />
			   		   </a>                	</div>					</td>
							...
							<td  valign="baseline" height="0">&nbsp;&nbsp;
                            <div align="center" class="style16  style14">
                            <%out.println(uname);%>
                            </div></td>
					...
					String status="Accepted";
								...
								String strQuery2 = "select * from requests where reqfrom='"+uname+"' and status='"+status+"'";
								ResultSet rs2 = stmt.executeQuery(strQuery2);
						
								while(rs2.next())
								{
								String reqto=rs2.getString(3);
									
								Statement stmt3=connection.createStatement();
								String strQuery3= "select * from usertweets where topicid='"+id+"' and user='"+reqto+"'";
								ResultSet rs3 = stmt.executeQuery(strQuery3);
						
								while(rs3.next())
								{
									String id3=rs3.getString(1);
									String user3=rs3.getString(2);
									String tweet3=rs3.getString(3);
									String date3=rs3.getString(4);
						%>
                     ...
                     <td width="113" rowspan="1" >
					   <div style="margin:10px 13px 10px 13px;" >
                		 <a class="#" id="img1" href="#" >
							<input  name="image" type="image" src="images.jsp?imgid=<%=id3%>" style="width:80px; height:80px;"  />
			   		   </a>                	</div>					</td>
