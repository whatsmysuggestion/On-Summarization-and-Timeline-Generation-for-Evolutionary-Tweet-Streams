...
<head>
<title>All Tweets Based On Rank</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style11">All Tweets Based On  Rank <span class="style5"></span></span></h2>
          </p>
          <div class="clr"></div>
            </div>
          </p>
              ...
              <%      
					...
					try{
                      ...
                      <%
								...
								String str= "select * from tweettopic order by count desc";
